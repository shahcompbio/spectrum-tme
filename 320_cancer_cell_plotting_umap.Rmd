...
boxplot_wrapper <- function(group_column, group_var_label, keys, comps, y_label, ylims, ncol, plabel = "p.signif") {
...
violins_pw_cluster <- boxplot_wrapper(cluster_label, "Cluster", pois_short, ".all.", "Expression", c(-1,8), 10)
...
violins_pw_cluster_pval <- boxplot_wrapper(cluster_label, "Cluster", pois_short, ".all.", "Expression", c(-1,8), 10, "p.format")
...
violins_hla_cluster <- boxplot_wrapper(cluster_label, "Cluster", gois[-7], ".all.", "Expression", c(0,6.1), 10)
...
violins_hla_cluster_pval <- boxplot_wrapper(cluster_label, "Cluster", gois[-7], ".all.", "Expression", c(0,6.1), 10, "p.format")
...
```{r chunk_320_120, fig.width=3, fig.height=2}
...
```{r chunk_320_180, fig.width=4, fig.height=7}
...
```{r chunk_320_200, fig.width=6, fig.height=12}
...
```{r chunk_320_220, fig.width=6, fig.height=16}

hla_patient_plots_grid <- plot_grid(plotlist = hla_patient_plots_list, ncol = 1, align = "v")
...
```{r chunk_320_240, fig.width=12, fig.height=3}
