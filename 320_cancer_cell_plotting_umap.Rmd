...
gois <- c("HLA-A", "HLA-B", "HLA-C", "B2M", "HLA-DRA", "HLA-DRB1")
...
```{r chunk_320_067, fig.width=3, fig.height=4.5}

plist3_2 <- default_comp_grid_list(filter(cluster_comp, sort_short_x == "CD45-"),
                                   cluster_label, "Cancer.cell.3", cluster_label,
                                   vec_plot = F, site_box = F, yaxis = T,
                                   super_type = "Ovarian.cancer.super")
...
pcomp_grid_p3_2
ggsave_pdf("figures/320_cancer_cell_plotting_umap/003_comp_plot_cluster3_mutsig.pdf", pcomp_grid_p3_2, width = 3, height = 4.5)
ggsave_png("figures/320_cancer_cell_plotting_umap/003_comp_plot_cluster3_mutsig.png", pcomp_grid_p3_2, width = 3, height = 4.5)
...
```{r chunk_320_068, fig.width=5, fig.height=5}
...
```{r chunk_320_071, fig.width=15, fig.height=2.5}
...
ggsave_png("figures/320_cancer_cell_plotting_umap/003_umap_genes.png", 
           add_umap_coord(umap_genes, x_offset = -0.175, textsize = 3), 
           width = 15, height = 2)
ggsave_pdf("figures/320_cancer_cell_plotting_umap/003_umap_genes.pdf", 
           add_umap_coord(umap_genes, x_offset = -0.175, textsize = 3), 
           width = 15, height = 2)
...
boxplot_wrapper <- function(group_column, group_var_label, keys, comps, y_label, ylims, ncol) {
...
violins_hla_cluster <- boxplot_wrapper(cluster_label, "Cluster", gois, ".all.", "Expression", c(0,6.1), 10)
...
```{r chunk_320_120, fig.width=6, fig.height=16}
