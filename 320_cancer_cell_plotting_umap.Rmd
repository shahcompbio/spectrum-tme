...
ggsave("figures/320_cancer_cell_plotting_umap/320_umap_cancer_kernels.pdf", width = 4.5, height = 4)
ggsave("figures/320_cancer_cell_plotting_umap/320_umap_cancer_kernels.png", width = 4.5, height = 4)

```

```{r chunk_320_074}

patient_ids <- group_by(plot_data, consensus_signature) %>% 
...
kernel_patient_wrapper <- function(csoi) {
  lapply(names(patient_ids[patient_ids == csoi]), 
       function(x) kernel_umap_wrapper(x, names(patient_ids[patient_ids == csoi]), 0.015, patient_id_short))
}
...
kernel_list$`HRD-Other` <- lapply(kernel_patient_wrapper("HRD-Other"), add, remove_guides)
kernel_list$`FBI` <- lapply(kernel_patient_wrapper("FBI"), add, remove_guides) 
kernel_list$`TD` <- lapply(kernel_patient_wrapper("TD"), add, remove_guides)
kernel_list$`Undetermined` <- lapply(kernel_patient_wrapper("Undetermined"), add, remove_guides)

kernel_patient_grid <- plot_grid(plotlist = unlist(kernel_list, recursive = F))

ggsave("figures/320_cancer_cell_plotting_umap/kernel_patient_grid.pdf", kernel_patient_grid, width = 30, height = 20)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins.pdf", width = 7.5, height = 3.5)
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins.png", width = 7.5, height = 3.5)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_pval.pdf", width = 7.5, height = 3.5)
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_pval.png", width = 7.5, height = 3.5)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short.pdf", width = 7.5, height = 2.75)
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short.png", width = 7.5, height = 2.75)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short_pval.pdf", width = 7.5, height = 2.75)
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short_pval.png", width = 7.5, height = 2.75)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_hla_pw_violins_mutsig.pdf", width = 12, height = 3)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_pathway_heatmap.pdf", width = 6.5, height = 3.75)
ggsave("figures/320_cancer_cell_plotting_umap/003_pathway_heatmap.png", width = 6.5, height = 3.75)
...
hla_grid_left
ggsave("figures/320_cancer_cell_plotting_umap/003_pathway_hla_heatmap.pdf", hla_grid_left, 
       width = 4.5, height = 7.5)
ggsave("figures/320_cancer_cell_plotting_umap/003_pathway_hla_heatmap.png", hla_grid_left, 
       width = 4.5, height = 7.5)
...
ggsave("figures/320_cancer_cell_plotting_umap/003_suppl_violins_grid.pdf", width = 20, height = 30)
