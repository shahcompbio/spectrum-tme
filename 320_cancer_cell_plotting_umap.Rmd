...
```{r chunk_320_086, fig.width=9, fig.height=3.5}

violins_hla_mutsig <- boxplot_wrapper(consensus_signature, "Mutational\nsignature", gois, my_comparisons, "Expression", c(0,6.1), 10)

violins_hla_mutsig

ggsave_pdf("figures/320_cancer_cell_plotting_umap/003_hla_violins.pdf", width = 9, height = 3.5)
ggsave_png("figures/320_cancer_cell_plotting_umap/003_hla_violins.png", width = 9, height = 3.5)
...
ggsave_pdf("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short.pdf", width = 9, height = 2.75)
ggsave_png("figures/320_cancer_cell_plotting_umap/003_hla_violins_mutsig_short.png", width = 9, height = 2.75)

```

```{r chunk_320_088, fig.width=12, fig.height=3.5}

violins_hla_cluster <- boxplot_wrapper(cluster_label, "Cluster", gois, ".all.", "Expression", c(0,6.1), 10)

violins_hla_cluster

ggsave_pdf("figures/320_cancer_cell_plotting_umap/003_hla_violins_cluster.pdf", width = 12, height = 3.5)
ggsave_png("figures/320_cancer_cell_plotting_umap/003_hla_violins_cluster.png", width = 12, height = 3.5)
