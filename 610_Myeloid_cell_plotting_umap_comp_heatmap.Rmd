...
common_layers_disc <- list(  
  ggrastr::geom_point_rast(size = pt_size, alpha = alpha_lvl, raster.dpi = 50),
  NoAxes(),
...
common_layers_cont <- list(  
  ggrastr::geom_point_rast(size = pt_size, alpha = alpha_lvl, raster.dpi = 30, scale = 0.1),
  NoAxes(),
...
umap_cell_type_void <- umap_cell_type + guides(color = "none")
umap_site_void <- umap_site + guides(color = "none")
...
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_cell_type_myeloid.pdf", width = 10, height = 5)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_cell_type_myeloid.png", width = 10, height = 5)
...
```{r chunk_610_61, fig.width=3, fig.height=1.5}
...
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_mini_macrophage.pdf", umap_mini_cluster_label_mp, width = 3, height = 1.5)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_mini_macrophage.png", umap_mini_cluster_label_mp, width = 3, height = 1.5)

```

```{r chunk_610_62, fig.width=1.5, fig.height=1.5}
...
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_mini_dc.pdf", umap_mini_cluster_label_dc, width = 1.5, height = 1.5)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_mini_dc.png", umap_mini_cluster_label_dc, width = 1.5, height = 1.5)
...
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_kernel.pdf", width = 5, height = 5)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_umap_kernel.png", width = 5, height = 5)
...
comp_tbl_sample_sort_dc <- plot_data_sub %>%
  mutate(cell_type_super_ml = ifelse(cluster_label %in% grep("DC", names(clrs$cluster_label[[coi]]), value = T), "Dendritic cell", "Macrophage")) %>% 
  filter(therapy == "pre-Rx", cell_type_super_ml == "Dendritic cell") %>%
  group_by(sample, tumor_subsite, tumor_supersite, tumor_megasite, patient_id_short,
           therapy, sort_short_x, consensus_signature, cluster_label, cell_type_super_ml) %>%
  tally %>%
  group_by(sample, tumor_subsite, tumor_supersite, tumor_megasite, patient_id_short,
...
plist9 <- default_comp_grid_list(
  comp_tbl_sample_sort_dc, cluster_label, "cDC1",
  cluster_label, super_type = "Myeloid.super", nmax = 800, highlight = T)

plist10 <- default_comp_grid_list(
  comp_tbl_sample_sort_dc, cluster_label, "cDC2",
  cluster_label, super_type = "Myeloid.super", nmax = 800, highlight = T)

plist11 <- default_comp_grid_list(
  comp_tbl_sample_sort_dc, cluster_label, "pDC",
  cluster_label, super_type = "Myeloid.super", nmax = 800, highlight = T)

plist12 <- default_comp_grid_list(
  comp_tbl_sample_sort_dc, cluster_label, "mDC",
  cluster_label, super_type = "Myeloid.super", nmax = 800, highlight = T)
...
comp_grid9 <- plot_grid(plotlist = plist9[-3], ncol = 1, align = "v", rel_heights = c(0.15, 0.15, 0.2, 0.5))

comp_grid10 <- plot_grid(plotlist = plist10[-3], ncol = 1, align = "v", rel_heights = c(0.15, 0.15, 0.2, 0.5))

comp_grid11 <- plot_grid(plotlist = plist11[-3], ncol = 1, align = "v", rel_heights = c(0.15, 0.15, 0.2, 0.5))

comp_grid12 <- plot_grid(plotlist = plist12[-3], ncol = 1, align = "v", rel_heights = c(0.15, 0.15, 0.2, 0.5))
...
comp_grid1
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_1.pdf", comp_grid1, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_1.png", comp_grid1, width = 3, height = 9)

comp_grid2
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_2.pdf", comp_grid2, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_2.png", comp_grid2, width = 3, height = 9)

comp_grid3
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_3.pdf", comp_grid3, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_3.png", comp_grid3, width = 3, height = 9)

comp_grid4
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_4.pdf", comp_grid4, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_4.png", comp_grid4, width = 3, height = 9)

comp_grid5
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_5.pdf", comp_grid5, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_5.png", comp_grid5, width = 3, height = 9)

comp_grid6
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_6.pdf", comp_grid6, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Macrophage.cell_comp_6.png", comp_grid6, width = 3, height = 9)
...
comp_grid7
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Myeloid.cell_comp.pdf", comp_grid7, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Myeloid.cell_comp.png", comp_grid7, width = 3, height = 9)

comp_grid8
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Myeloid.cell_comp_no_ascites.pdf", comp_grid8, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_Myeloid.cell_comp_no_ascites.png", comp_grid8, width = 3, height = 9)

```

```{r chunk_610_105, fig.width=3, fig.height=9}

comp_grid9
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_cDC1_comp.pdf", comp_grid9, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_cDC1_comp.png", comp_grid9, width = 3, height = 9)

comp_grid10
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_cDC2_comp.pdf", comp_grid10, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_cDC2_comp.png", comp_grid10, width = 3, height = 9)

comp_grid11
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_pDC_comp.pdf", comp_grid11, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_pDC_comp.png", comp_grid11, width = 3, height = 9)

comp_grid12
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_mDC_comp.pdf", comp_grid12, width = 3, height = 9)
ggsave("figures/610_Myeloid_cell_plotting_umap_comp_heatmap/005_DC_mDC_comp.png", comp_grid12, width = 3, height = 9)
...
umap_heat_grid <- ggdraw() +
  draw_plot(add_umap_coord(umap_cell_type_void, x_offset = -0.015, y_offset = -0.02, width = 0.4, height = 0.4),
