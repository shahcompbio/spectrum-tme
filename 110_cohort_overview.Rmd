...
cairo_pdf("figures/110_cohort_overview/110_cohort_overview.pdf", width = 9, height = 8.8)
print(cohort_ht)
dev.off()

png("figures/110_cohort_overview/110_cohort_overview.png", width = 9, height = 8.8, res = 300)
print(cohort_ht)
dev.off()
