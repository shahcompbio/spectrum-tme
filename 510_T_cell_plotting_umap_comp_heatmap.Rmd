...
```{r chunk_510_62, fig.width=6, fig.height=5}
...
```{r chunk_510_63, fig.width=6, fig.height=5}
...
kernel_umap_wrapper(c("HRD-Dup", "HRD-Del"), c("FBI"), 0.01, "Enrichm. in\nHRD vs HRP") + labs(title = "")

ggsave("figures/510_T_cell_plotting_umap_comp_heatmap/004_umap_kernel_hrd_hrp.pdf", width = 6, height = 5)
ggsave("figures/510_T_cell_plotting_umap_comp_heatmap/004_umap_kernel_hrd_hrp.png", width = 6, height = 5)
...
```{r chunk_510_65, fig.width=4.5, fig.height=12}
...
umap_mini_cluster_label_sub <- ggplot() + 
  ggrastr::geom_point_rast(
    ...
    alpha = 0.1, size = 0.01, color = "grey80",
    raster.dpi = 15, scale = 0.02
  ) +
  ggrastr::geom_point_rast(
