...
violins_grid_mutsig_mp <- plot_grid(
  violins_genes_mutsig_mp, violins_pw_mutsig_mp,
  nrow = 1, rel_widths = c(0.63, 0.37), align = "h")

violins_grid_mutsig_mp

ggsave_pdf("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots.pdf", violins_grid_mutsig_mp, width = 4.5, height = 3.5)
ggsave_png("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots.png", violins_grid_mutsig_mp, width = 4.5, height = 3.5)

```

```{r chunk_620_142, fig.width=5, fig.height=4}

violins_genes_mutsig_short_mp <- boxplot_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
...
violins_grid_mutsig_short_mp <- plot_grid(
  violins_genes_mutsig_short_mp, violins_pw_mutsig_short_mp,
  nrow = 1, rel_widths = c(0.63, 0.37), align = "h")

violins_grid_mutsig_short_mp

ggsave_pdf("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots_mutsig_short.pdf", violins_grid_mutsig_short_mp, width = 4.5, height = 3)
ggsave_png("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots_mutsig_short.png", violins_grid_mutsig_short_mp, width = 4.5, height = 3)
...
violins_genes_mutsig_dc
ggsave_pdf("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots.pdf", violins_genes_mutsig_dc, width = 4.5, height = 3.5)
ggsave_png("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots.png", violins_genes_mutsig_dc, width = 4.5, height = 3.5)

violins_genes_mutsig_dc_short
ggsave_pdf("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots_mutsig_short.pdf", violins_genes_mutsig_dc_short, width = 4.5, height = 3)
ggsave_png("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots_mutsig_short.png", violins_genes_mutsig_dc_short, width = 4.5, height = 3)
...
cor_plot1 <- plot_data_cor %>%
  ...
  filter(key_x == "Interferon.regulators.module", key_y == "JAK.STAT.pathway") %>%
