...
seu_obj_mp <- read_rds("/work/shah/users/uhlitzf/data/SPECTRUM/freeze/v7/Macrophages_processed.rds")

seu_obj_dc <- read_rds("/work/shah/users/uhlitzf/data/SPECTRUM/freeze/v7/DCs_processed.rds")
...
seu_obj_tc <- read_rds("/work/shah/users/uhlitzf/data/SPECTRUM/freeze/v7/T.super_processed_filtered_annotated.rds")
...
violin_wrapper <- function(plot_data_vio, plot_data_vio_summary, group_column, y, 
...
boxplot_wrapper <- function(plot_data_vio, plot_data_vio_summary, group_column, y, keys, comps, group_var_label, y_label, ylims, ncol, plabel = "p.signif", mut_filter = mois, site_filter = names(clrs$tumor_supersite), megasite_filter = sois, facet_site = T) {
  ...
  boxplot_data <- filter(plot_data_vio_summary, 
                         ...
                         tumor_megasite %in% megasite_filter)
  
  p <- ggplot(boxplot_data, aes(!!group_column, !!y)) +
    geom_boxplot(aes(!!group_column, !!y, color = !!group_column),
                 width = 0.5, size = 0.75, outlier.shape = NA) +
    geom_boxplot(aes(!!group_column, !!y, fill = !!group_column),
                 color = "white", width = 0.5, outlier.shape = NA, size = 0.5) +
    geom_jitter(aes(!!group_column, !!y),
...
```{r chunk_620_150, fig.width=5, fig.height=3}

violins_genes_mutsig_mp_pdl1 <- violin_wrapper(
...
violins_genes_mutsig_mp_cxcl10 <- violin_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
  consensus_signature, pct.expr, 
  c("CXCL10"), 
...
violins_pw_mutsig_mp <- violin_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
...
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_violins.pdf", violins_grid_mutsig_mp, width = 5, height = 3)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_violins.png", violins_grid_mutsig_mp, width = 5, height = 3)

```

```{r chunk_620_160, fig.width=5, fig.height=5}

boxplots_genes_mutsig_mp_pdl1 <- boxplot_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
  consensus_signature, pct.expr, 
  c("CD274"), 
  my_comparisons, "Mutational\nsignature", "% Pos. Macroph.", c(0,30), 5
)

boxplots_genes_mutsig_mp_cxcl10 <- boxplot_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
  consensus_signature, pct.expr, 
  c("CXCL10"), 
  my_comparisons, "Mutational\nsignature", "% Pos. Macroph.", c(0,100), 5
...
boxplots_pw_mutsig_mp <- boxplot_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
  consensus_signature, value, 
  "JAK/STAT\npathway", 
  my_comparisons, "Mutational\nsignature", "PROGENy score", c(-1, 5), 5
...
boxplots_grid_mutsig_mp <- plot_grid(
  boxplots_genes_mutsig_mp_pdl1, boxplots_genes_mutsig_mp_cxcl10, boxplots_pw_mutsig_mp,
  nrow = 1, align = "hv")

boxplots_grid_mutsig_mp

ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots.pdf", boxplots_grid_mutsig_mp, width = 6, height = 5)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_boxplots.png", boxplots_grid_mutsig_mp, width = 6, height = 5)

```

```{r chunk_620_170, fig.width=5, fig.height=4}

violins_genes_mutsig_short_mp_pdl1 <- violin_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
...
violins_genes_mutsig_short_mp_cxcl10 <- violin_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
  consensus_signature_short, pct.expr, 
  c("CXCL10"), 
  my_comparisons2, "Mutational\nsignature", "% Pos. Macroph.", c(0,100), 5
...
violins_pw_mutsig_short_mp <- violin_wrapper(
  plot_data_vio_mp, plot_data_vio_mp_summary, 
...
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_violins_mutsig_short.pdf", violins_grid_mutsig_short_mp, width = 5, height = 3)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_macrophage_violins_mutsig_short.png", violins_grid_mutsig_short_mp, width = 5, height = 3)
...
```{r chunk_620_180, fig.width=5, fig.height=3.5}
...
violins_genes_mutsig_dc <- violin_wrapper(
...
violins_pw_mutsig_dc <- violin_wrapper(
  plot_data_vio_dc, plot_data_vio_dc_summary, 
  consensus_signature, value, 
  "IFN\nregulators", 
...
violins_genes_mutsig_dc_short <- violin_wrapper(
  plot_data_vio_dc, plot_data_vio_dc_summary, 
  consensus_signature_short, pct.expr, 
  c("IRF1", "IRF7", "IRF8", "IRF9"), 
  my_comparisons2, "Mutational\nsignature", "% Pos. DCs", c(0,100), 5
...
violins_pw_mutsig_dc_short <- violin_wrapper(
  plot_data_vio_dc, plot_data_vio_dc_summary, 
  consensus_signature_short, value, 
  "IFN\nregulators", 
  my_comparisons2, "Mutational\nsignature", "Module score", c(-1, 2), 5
...
```{r chunk_620_190, fig.width=5, fig.height=3.5}

plot_grid(violins_genes_mutsig_dc, violins_pw_mutsig_dc, 
          nrow = 1, rel_widths = c(0.73, 0.27), align = "h")

ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_violins.pdf", width = 6, height = 3)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_violins.png", width = 6, height = 3)

```

```{r chunk_620_200, fig.width=5, fig.height=3.5}

plot_grid(violins_genes_mutsig_dc_short, violins_pw_mutsig_dc_short, 
          nrow = 1, rel_widths = c(0.73, 0.27))

ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_violins_mutsig_short.pdf", width = 6, height = 3)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_violins_mutsig_short.png", width = 6, height = 3)

```

```{r chunk_620_210, fig.width=5, fig.height=3.5}

boxplots_genes_mutsig_dc <- boxplot_wrapper(
  plot_data_vio_dc, plot_data_vio_dc_summary, 
  consensus_signature, pct.expr, 
  c("IRF1", "IRF7", "IRF8", "IRF9"), 
  my_comparisons, "Mutational\nsignature", "% Pos. DCs", c(0,100), 5
...
boxplots_pw_mutsig_dc <- boxplot_wrapper(
  plot_data_vio_dc, plot_data_vio_dc_summary, 
  consensus_signature, value, 
  "IFN\nregulators", 
  my_comparisons, "Mutational\nsignature", "Module score", c(-1, 2), 5
...
plot_grid(boxplots_genes_mutsig_dc, boxplots_pw_mutsig_dc, 
          nrow = 1, rel_widths = c(0.73, 0.27), align = "h")

ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots.pdf", width = 7, height = 5)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_boxplots.png", width = 7, height = 5)
...
```{r chunk_620_220, fig.width=6, fig.height=4}
...
```{r chunk_620_230, fig.width=8, fig.height=3.25}
...
cor_plot1 <- plot_data_cor %>%
  ...
  scale_color_manual(values = c(clrs$consensus_signature[mois])) +
...
cor_plot1
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_cancer_cell_correlation.pdf", cor_plot1, width = 9, height = 3.25)
ggsave("figures/620_Macrophage_umaps_and_boxplots/005_DC_cancer_cell_correlation.png", cor_plot1, width = 9, height = 3.25)
