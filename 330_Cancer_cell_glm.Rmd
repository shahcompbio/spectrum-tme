...
plot_data <- bind_rows(consensus_signature_odds %>% add_column(contrast_variable = "Signature"),
  ...
  #        log2.odds.ratio = ifelse(log2.odds.ratio < -4, -4, log2.odds.ratio))
...
p_odds_ratio <- plot_data %>%
  ...
  # geom_tile() +
  geom_point() +
  # geom_point(data = filter(plot_data, p.value < 0.0001)) +#, shape = "*", size = 4, color = "black") +
  # scale_color_distiller(palette = "RdBu", direction = -1, breaks=c(-2,0,2)) +
  ...
  #   breaks = c(-4, -2, 0, 2)
  # ) +
  # scale_color_distiller(palette = "RdBu", direction = -1, values=rescale(c(-4,-2,0,2)), limits=c(-4,2), breaks=c(-4,-2,0,2)) +
  # scale_color_distiller(palette = "RdBu", trans = "log2", direction = -1) +
  # scale_color_distiller(palette = "RdBu", direction = -1,
  #                       values=rescale(c(0,1,3)), limits=c(0,3), breaks=c(0,1,2,3),
  #                       oob = scales::squish, labels = c("0", "1", "2", ">3")) +
  # scale_color_distiller(palette = "RdBu", direction = -1, values=rescale(c(0,1,4)), limits=c(0,4), breaks=c(0,1,2,4)) +
  # scale_color_gradient2(low="navy", mid="white", high="red", midpoint=1, breaks=c(0.2,1,2)) +
  scale_color_gradientn(
    colors = rev(brewer.pal(9, "RdBu")),
...
p_left <-
  plot_grid(
    p_signature_site_anno + theme(plot.margin = margin(t = 10, r = 0, b = 12, l = 6)),
    ggdraw(),
    nrow = 2,
    align = "hv",
    axis = "tbr",
